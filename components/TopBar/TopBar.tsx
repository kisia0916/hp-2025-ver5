  ...
  return (
    <>
        <div className='w-full h-17 flex justify-between'>
            ...
            <div>
                <button className="p-2 flex items-center h-full text-2xl mt-1 mr-2">
            ...
            {/* <div className='h-full flex ml-4'>
                <div className='m-auto mt-4 text-1xl flex'>
                    <img src="/logo/logo4.png" className='w-8 h-8 mt-1 mr-2'/>
                    <div>
        ...
        <div className='w-full flex'>
            <div className='m-auto w-[92%] h-[1px] bg-black rounded-2xl'>
