    ...
    >
        ...
        <div className='w-full flex'>
            <div className='mt-7 w-full border-1 rounded-3xl border-gray-800 bg-white'>
                ...
                <NewsContent date='2025.09.22' link='https://kigyokusai.com/drop' is_bottom={false} title='落とし物について'/>
                <NewsContent date='2025.09.17' link='https://kurumi.kigyokusai.com' is_bottom={false} title='デジタルパンフレットを公開しました！'/>
                <NewsContent date='2025.08.22' link='https://kigyokusai.com' is_bottom={true} title='ホームページを公開しました！'/>
                <div className='h-7'>
